            ...
            <footer className="bg-black text-white mt-12">
                <div className="container mx-auto py-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li>
                                    <Link href="/markets">
                                        <span className="text-gray-400 hover:text-neo-green transition-colors">Markets</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/create">
                                        <span className="text-gray-400 hover:text-neo-green transition-colors">Create Market</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/my-predictions">
                                        <span className="text-gray-400 hover:text-neo-green transition-colors">My Positions</span>
                                    </Link>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li>
                                    <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-neo-green transition-colors">
                                        Twitter
                                    </a>
                                </li>
                                <li>
                                    <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-neo-green transition-colors">
                                        Discord
                                    </a>
                                </li>
                                <li>
                                    <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-neo-green transition-colors">
                                        GitHub
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                        <p>&copy; {new Date().getFullYear()} radish.xyz. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </div>
